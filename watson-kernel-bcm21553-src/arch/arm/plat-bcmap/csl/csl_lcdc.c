...
#define     TASKPRI_LCDC              (TPriority_t)(HIGHEST)
...
CSL_LCD_RES_T CSL_LCDC_WrCmnd(CSL_LCD_HANDLE lcdcH, UInt32 command)
{
	...
	// WATSON: trying to reduce overhead by keeping the AHB LCD clk always on
	//CSL_LCDC_DIS_AHB_CLK();
...
/* ***************************************************************************** */
CSL_LCD_RES_T CSL_LCDC_PAR_RdData(CSL_LCD_HANDLE lcdcH, uint32_t * data)
{
	LCDC_HANDLE lcdc = (LCDC_HANDLE) lcdcH;
	CSL_LCD_RES_T res = CSL_LCD_OK;
