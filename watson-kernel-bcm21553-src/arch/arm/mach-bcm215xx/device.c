...
#define BCM_CORE_CLK_TURBOMID			BCM21553_CORECLK_KHZ_910
#define BCM_CORE_CLK_TURBOHIGH			BCM21553_CORECLK_KHZ_1040
...
static struct bcm_freq_tbl bcm215xx_cpu0_freq_tbl[] = {
	...
	//312
	FTBL_INIT(BCM_CORE_CLK_SLEEPING_BEAUTY / 1000, 1200000),
	//416
	//FTBL_INIT(BCM_CORE_CLK_LOWEST / 1000, 1220000),
	//520
	//FTBL_INIT(BCM_CORE_CLK_LOW / 1000, 1240000),
	//624
	FTBL_INIT(BCM_CORE_CLK_NORMAL / 1000, 1260000),
	//728
	FTBL_INIT(BCM_CORE_CLK_MIDDLE / 1000, 1300000),
	//832
	FTBL_INIT(BCM_CORE_CLK_TURBOLOW / 1000, 1360000),
	//910
	FTBL_INIT(BCM_CORE_CLK_TURBOMID / 1000, 1380000),
	//1040
	FTBL_INIT(BCM_CORE_CLK_TURBOHIGH / 1000, 1400000),
};
/* BCM21553 CPU info */
static struct bcm_cpu_info bcm215xx_cpu_info[] = {
	[0] = {
		...
		.index_turbolo = BCM_TURBO_MODE_LOW,
		.index_turbomd = BCM_TURBO_MODE_MIDDLE,
		.index_turbohi = BCM_TURBO_MODE_HIGH,
		.index_middle = BCM_MIDDLE_MODE,
		.index_normal = BCM_NORMAL_MODE,
		//.index_low = BCM_LOW_MODE,
		//.index_lowest = BCM_LOWEST_MODE,
		.index_sleepingbeauty = BCM_SLEEP_MODE,
	},
};
...
static struct bcm21553_cpufreq_gov_plat bcm21553_cpufreq_gov_plat = {
	.freq_sleepingbeauty = BCM_CORE_CLK_SLEEPING_BEAUTY,
	//.freq_lowest = BCM_CORE_CLK_LOWEST,
	//.freq_low = BCM_CORE_CLK_LOW,
	.freq_normal = BCM_CORE_CLK_NORMAL,
	.freq_middle = BCM_CORE_CLK_MIDDLE,
	.freq_turbolo = BCM_CORE_CLK_TURBOLOW,
	.freq_turbomd = BCM_CORE_CLK_TURBOMID,
	.freq_turbohi = BCM_CORE_CLK_TURBOHIGH,
};
...
#define NM2_FF_VOLTAGE_LOWEST		1060000
#define NM2_TT_VOLTAGE_LOWEST		1120000
#define NM2_SS_VOLTAGE_LOWEST		1180000

#define NM2_FF_VOLTAGE_LOWER		1090000
#define NM2_TT_VOLTAGE_LOWER		1150000
#define NM2_SS_VOLTAGE_LOWER		1210000

//#define NM2_FF_VOLTAGE_LOW			1120000
//#define NM2_TT_VOLTAGE_LOW			1180000
//#define NM2_SS_VOLTAGE_LOW			1240000

#define NM2_FF_VOLTAGE_NORMAL		1140000
#define NM2_TT_VOLTAGE_NORMAL		1200000
#define NM2_SS_VOLTAGE_NORMAL		1260000

#define NM2_FF_VOLTAGE_MIDLOW		1160000
#define NM2_TT_VOLTAGE_MIDLOW		1220000
#define NM2_SS_VOLTAGE_MIDLOW		1280000

#define NM2_FF_VOLTAGE_MIDDLE		1180000
#define NM2_TT_VOLTAGE_MIDDLE		1240000
#define NM2_SS_VOLTAGE_MIDDLE		1300000

#define NM2_FF_VOLTAGE_MIDHIGH		1240000
#define NM2_TT_VOLTAGE_MIDHIGH		1300000
#define NM2_SS_VOLTAGE_MIDHIGH		1360000

#define NM2_FF_VOLTAGE_HIGH			1310000
#define NM2_TT_VOLTAGE_HIGH			1370000
#define NM2_SS_VOLTAGE_HIGH			1430000

#define NM2_FF_VOLTAGE_TURBO		1380000
#define NM2_TT_VOLTAGE_TURBO		1440000
#define NM2_SS_VOLTAGE_TURBO		1500000

#define NM2_FF_VOLTAGE_TURBOHIGH	1450000
#define NM2_TT_VOLTAGE_TURBOHIGH	1510000
#define NM2_SS_VOLTAGE_TURBOHIGH	1570000

#define NM_FF_VOLTAGE				1400000
#define NM_TT_VOLTAGE				1400000
#define NM_SS_VOLTAGE				1440000
...
static struct silicon_type_info part_type_ss = {
	...
	.nm2_lowest_voltage = NM2_SS_VOLTAGE_LOWEST,
	.nm2_lower_voltage = NM2_SS_VOLTAGE_LOWER,
//	.nm2_low_voltage = NM2_SS_VOLTAGE_LOW,
	.nm2_normal_voltage = NM2_SS_VOLTAGE_NORMAL,
	.nm2_midlow_voltage = NM2_SS_VOLTAGE_MIDLOW,
	.nm2_middle_voltage = NM2_SS_VOLTAGE_MIDDLE,
	.nm2_midhigh_voltage = NM2_SS_VOLTAGE_MIDHIGH,
	.nm2_high_voltage = NM2_SS_VOLTAGE_MIDHIGH,
	.nm2_turbo_voltage = NM2_SS_VOLTAGE_MIDHIGH,
	.nm2_turbohigh_voltage = NM2_SS_VOLTAGE_MIDHIGH,
};

static struct silicon_type_info part_type_tt = {
	.lpm_voltage = -1, /* Pass -1 if no update needed */
	.nm_voltage = NM_TT_VOLTAGE,
	.nm2_lowest_voltage = NM2_TT_VOLTAGE_LOWEST,
	.nm2_lower_voltage = NM2_TT_VOLTAGE_LOWER,
//	.nm2_low_voltage = NM2_TT_VOLTAGE_LOW,
	.nm2_normal_voltage = NM2_TT_VOLTAGE_NORMAL,
	.nm2_midlow_voltage = NM2_TT_VOLTAGE_MIDLOW,
	.nm2_middle_voltage = NM2_TT_VOLTAGE_MIDDLE,
	.nm2_midhigh_voltage = NM2_TT_VOLTAGE_MIDHIGH,
	.nm2_high_voltage = NM2_TT_VOLTAGE_MIDHIGH,
	.nm2_turbo_voltage = NM2_TT_VOLTAGE_MIDHIGH,
	.nm2_turbohigh_voltage = NM2_TT_VOLTAGE_MIDHIGH,
};

static struct silicon_type_info part_type_ff = {
	.lpm_voltage = -1, /* Pass -1 if no update needed */
	.nm_voltage = NM_FF_VOLTAGE,
	.nm2_lowest_voltage = NM2_FF_VOLTAGE_LOWEST,
	.nm2_lower_voltage = NM2_FF_VOLTAGE_LOWER,
//	.nm2_low_voltage = NM2_FF_VOLTAGE_LOW,
	.nm2_normal_voltage = NM2_FF_VOLTAGE_NORMAL,
	.nm2_midlow_voltage = NM2_FF_VOLTAGE_MIDLOW,
	.nm2_middle_voltage = NM2_FF_VOLTAGE_MIDDLE,
	.nm2_midhigh_voltage = NM2_FF_VOLTAGE_MIDHIGH,
	.nm2_high_voltage = NM2_FF_VOLTAGE_MIDHIGH,
	.nm2_turbo_voltage = NM2_FF_VOLTAGE_MIDHIGH,
	.nm2_turbohigh_voltage = NM2_FF_VOLTAGE_MIDHIGH,
};
...
static void bcm215xx_avs_notify(int silicon_type)
{
	...
	case SILICON_TYPE_SLOW:
		lowest = part_type_ss.nm2_lowest_voltage;
		lower = part_type_ss.nm2_lower_voltage;
		low = part_type_ss.nm2_low_voltage;
		normal = part_type_ss.nm2_normal_voltage;
		midlow = part_type_ss.nm2_midlow_voltage;
		middle = part_type_ss.nm2_middle_voltage;
		midhigh = part_type_ss.nm2_midhigh_voltage;
		high = part_type_ss.nm2_midhigh_voltage;
		turbo = part_type_ss.nm2_midhigh_voltage;
		turbohigh = part_type_ss.nm2_midhigh_voltage;
		break;

	case SILICON_TYPE_TYPICAL:
		lowest = part_type_tt.nm2_lowest_voltage;
		lower = part_type_tt.nm2_lower_voltage;
//		low = part_type_tt.nm2_low_voltage;
		normal = part_type_tt.nm2_normal_voltage;
		midlow = part_type_tt.nm2_midlow_voltage;
		middle = part_type_tt.nm2_middle_voltage;
		midhigh = part_type_tt.nm2_midhigh_voltage;
		high = part_type_tt.nm2_midhigh_voltage;
		turbo = part_type_tt.nm2_midhigh_voltage;
		turbohigh = part_type_tt.nm2_midhigh_voltage;
		break;

	case SILICON_TYPE_FAST:
		lowest = part_type_ff.nm2_lowest_voltage;
		lower = part_type_ff.nm2_lower_voltage;
//		low = part_type_ff.nm2_low_voltage;
		normal = part_type_ff.nm2_normal_voltage;
		midlow = part_type_ff.nm2_midlow_voltage;
		middle = part_type_ff.nm2_middle_voltage;
		midhigh = part_type_ff.nm2_midhigh_voltage;
		high = part_type_ff.nm2_midhigh_voltage;
		turbo = part_type_ff.nm2_midhigh_voltage;
		turbohigh = part_type_ff.nm2_midhigh_voltage;
		break;
...
//		low = part_type_ss.nm2_low_voltage;
	...
	if (lowest >= 0)
	{
		bcm215xx_cpu0_freq_tbl[BCM_LOWEST_MODE].cpu_voltage =
			(u32)lowest;
	}
	if (lower >= 0)
	{
	...
	if (normal >= 0)
	{
		bcm215xx_cpu0_freq_tbl[BCM_NORMAL_MODE].cpu_voltage =
			(u32)normal;
		bcm215xx_cpu0_freq_tbl[BCM_MIDLOW_MODE].cpu_voltage =
			(u32)normal;
		bcm215xx_cpu0_freq_tbl[BCM_MIDDLE_MODE].cpu_voltage =
			(u32)normal;
		bcm215xx_cpu0_freq_tbl[BCM_MIDHIGH_MODE].cpu_voltage =
			(u32)normal;
		bcm215xx_cpu0_freq_tbl[BCM_HIGH_MODE].cpu_voltage =
			(u32)normal;
	}
	if (turbo >= 0)
		bcm215xx_cpu0_freq_tbl[BCM_TURBO_MODE].cpu_voltage =
			(u32)turbo;
		bcm215xx_cpu0_freq_tbl[BCM_TURBOHIGH_MODE].cpu_voltage =
			(u32)turbo;
}
#else
