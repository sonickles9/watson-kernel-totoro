...
enum {
	...
	CAM_CMD_WRITE_REG,
	CAM_CMD_GET_FRAME,
	CAM_CMD_GET_JPEG_AND_THUMBNAIL,
	CAM_CMD_SET_PARAMS,
...
#define CAM_IOCTL_GET_FRAME	_IOWR(BCM_CAM_MAGIC, CAM_CMD_GET_FRAME, CAM_Frame_t)
#define CAM_IOCTL_GET_JPEG_AND_THUMBNAIL _IOWR(BCM_CAM_MAGIC, CAM_CMD_GET_JPEG_AND_THUMBNAIL, CAM_Jpeg_Thumbnail_t)
...
#define CAM_IOCTL_GET_SENSOR_VALUES_FOR_EXIF _IOWR( BCM_CAM_MAGIC, CAM_CMD_GET_SENSOR_VALUES_FOR_EXIF, CAM_Sensor_Values_For_Exif_t )
#define CAM_IOCTL_GET_ESD_VALUE _IOWR( BCM_CAM_MAGIC, CAM_CMD_GET_ESD_VALUE, bool )

typedef struct {
	unsigned char *jpegBuf;
	unsigned int jpegLength;
	unsigned char *thumbBuf;	
} CAM_Jpeg_Thumbnail_t;
...
//BYKIM_ZOOM
typedef enum {
	CamZoom_1_0 = 256,	/* /< zoom factor 1.0 */  //0
	CamZoom_1_125 = 227,	/* /< zoom factor 1.15   (256/224) */ // 1
	CamZoom_1_15 = 224,	/* /< zoom factor 1.15   (256/224) */
	CamZoom_1_2 = 216,      /* /< zoom factor 1.2   (256/216) */
	CamZoom_1_25 = 205,	/* /< zoom factor 1.2   (256/216) */ //  2
	CamZoom_1_33 = 192,	/* /< zoom factor 1.33   (256/192) */
	CamZoom_1_375 = 186,	/* /< zoom factor 1.33   (256/192) */  //  3
	CamZoom_1_4 = 184,      /* /< zoom factor 1.4   (256/184) */
	CamZoom_1_5 = 171,	/* /< zoom factor 1.6    (256/160) */ //  4
	CamZoom_1_6 = 160,	/* /< zoom factor 1.6    (256/160) */
	CamZoom_1_625 = 157,	/* /< zoom factor 1.6    (256/160) */ //  5
	CamZoom_1_65 = 155,	/* /< zoom factor 1.6    (256/160) */
	CamZoom_1_75 = 146,	/* /< zoom factor 1.6    (256/160) */ // 6
	CamZoom_1_8 = 144,      /* /< zoom factor 1.8    (256/144) */
	CamZoom_1_875 = 136,	/* /< zoom factor 1.8    (256/144) */ // 7
	CamZoom_2_0 = 128,	/* /< zoom factor 2.0    (256/128) */ //  8
...
*/
typedef enum {
	CamBrightnessLevel_0 = 0x00000001,	/* /< auto white balance */
	CamBrightnessLevel_1 = 0x00000002,	/* /< no white balance */
	CamBrightnessLevel_2 = 0x00000004,	/* /< daylight */
	CamBrightnessLevel_3 = 0x00000008,	/* /< cloudy */
	CamBrightnessLevel_4 = 0x00000010,	/* /< incandescent */
	CamBrightnessLevel_5 = 0x00000020,	/* /< warm fluorescent */
	CamBrightnessLevel_6 = 0x00000040,	/* /< cool fluorescent */
	CamBrightnessLevel_7 = 0x00000080,	/* /< daylight fluorescent */
	CamBrightnessLevel_8 = 0x00000100,	/* /< shade */
} CamBrightnessLevel_t;
...
#else
typedef enum {
	CamContrast_m2 =  0x00000001,	/* /< minus 2 Contrast */
	CamContrast_m1 =  0x00000002,	/* /< minus 1  Contrast */
	CamContrast_0 =   0x00000003,	/* /nominal Contrast */
	CamContrast_p1 =  0x00000004,	/* /< minus 2 Contrast */
	CamContrast_p2 =  0x00000005,	/* /< minus 1  Contrast */	
} CamContrast_t;
#endif
typedef enum {
...
#else
typedef enum {
	CamSaturation_m2 =  0x00000001,	/* /< minus 2 Contrast */
	CamSaturation_m1 =  0x00000002,	/* /< minus 1  Contrast */
	CamSaturation_0 =   0x00000003,	/* /nominal Contrast */
	CamSaturation_p1 =  0x00000004,	/* /< minus 2 Contrast */
	CamSaturation_p2 =  0x00000005,	/* /< minus 1  Contrast */	
} CamSaturation_t;
#endif
typedef enum {
...
#else
typedef enum {
	CamSharpness_m2 =  0x00000001,	/* /< minus 2 Contrast */
	CamSharpness_m1 =  0x00000002,	/* /< minus 1  Contrast */
	CamSharpness_0 =   0x00000003,	/* /nominal Contrast */
	CamSharpness_p1 =  0x00000004,	/* /< minus 2 Contrast */
	CamSharpness_p2 =  0x00000005,	/* /< minus 1  Contrast */	
} CamSharpness_t;
#endif
typedef enum {
...
typedef enum {
	 CamJpegQuality_Min = 7,       /* minimum JpegQuality */
...
typedef enum {
	Cam_Capture_JPEG, 	//JPEG Capture
	Cam_Capture_YUV 	// YUV capture
} CamCapture_t;

typedef struct {
	unsigned int stillMode_noOf_res;
	unsigned int stillMode_res[10][2];
	unsigned int stillMode_noOf_formats;
	CamDataFmt_t stillMode_format[5];

	unsigned int stillMode_thumb_noOf_res;
	unsigned int stillMode_thumb_res[10][2];
	unsigned int stillMode_thumb_noOf_formats;
	CamDataFmt_t stillMode_thumb_format[5];

	unsigned int previewMode_noOf_res;
	unsigned int previewMode_res[10][2];
	unsigned int previewMode_noOf_formats;
	CamDataFmt_t previewMode_format[5];

	unsigned int zoom_noOf_steps;
	CamZoom_t    zoom_steps[25];
