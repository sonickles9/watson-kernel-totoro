...
static struct yas_bma222_data acc_data;
...
static const struct yas_bma222_odr yas_bma222_odr_tbl[] = {
    ...
    {1,   YAS_BMA222_BANDWIDTH_125HZ},
    {2,   YAS_BMA222_BANDWIDTH_63HZ},
    {4,   YAS_BMA222_BANDWIDTH_32HZ},
    {8,   YAS_BMA222_BANDWIDTH_16HZ},
    {16,  YAS_BMA222_BANDWIDTH_8HZ},
#endif
...
/* Sleep duration */
static const struct yas_bma222_sd yas_bma222_sd_table[] = {
...
static const int yas_bma222_position_map[][3][3] = {
...
static int bma222_set_sleep_dur(unsigned char bw)
{
    ...
    for (i = 0; i < (int)(sizeof(yas_bma222_sd_table) / sizeof(struct yas_bma222_sd)); i++) {
...
static int yas_bma222_set_delay(int delay)
{
    ...
    for (i = 1; i < (int)(sizeof(yas_bma222_odr_tbl) / sizeof(struct yas_bma222_odr)) &&
...
static int yas_bma222_data_filter(int data[], int raw[], struct yas_bma222_acceleration *accel)
{
...
static int yas_bma222_measure(int *out_data, int *out_raw)
{
    ...
    for (i = 0; i < 3; i++) {
        ...
        data[i] = 0;
        for (j = 0; j < 3; j++) {
            data[i] += raw[j] * yas_bma222_position_map[pos][i][j];
        }
        /* normalization */
