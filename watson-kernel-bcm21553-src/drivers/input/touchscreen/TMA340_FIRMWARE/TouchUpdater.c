...
unsigned char Firmware_Data_HW10[]= 
{
#include "Firmware_cooperve54_HW10.h"
};
#if 0		// cooper (GT-S5830)
...
#endif
#endif
	if( HW_ver == 0x04 || HW_ver == 0x05 || HW_ver == 0x10 )
		pSocData = Firmware_Data_HW10;
	else
	{
