...
typedef enum eCamacqSensorData_e
{
    ...
    CAMACQ_SENSORDATA_X2_Zoom_0,
    CAMACQ_SENSORDATA_X2_Zoom_1,
    CAMACQ_SENSORDATA_X2_Zoom_2,
    CAMACQ_SENSORDATA_X2_Zoom_3,
    CAMACQ_SENSORDATA_X2_Zoom_4,
    CAMACQ_SENSORDATA_X2_Zoom_5,
    CAMACQ_SENSORDATA_X2_Zoom_6,
    CAMACQ_SENSORDATA_X2_Zoom_7, // 110
    CAMACQ_SENSORDATA_X2_Zoom_8,

    CAMACQ_SENSORDATA_X1_6_Zoom_0,
    CAMACQ_SENSORDATA_X1_6_Zoom_1,
    CAMACQ_SENSORDATA_X1_6_Zoom_2,
    CAMACQ_SENSORDATA_X1_6_Zoom_3,
    CAMACQ_SENSORDATA_X1_6_Zoom_4,
    CAMACQ_SENSORDATA_X1_6_Zoom_5,
    CAMACQ_SENSORDATA_X1_6_Zoom_6,
    CAMACQ_SENSORDATA_X1_6_Zoom_7,
    CAMACQ_SENSORDATA_X1_6_Zoom_8, // 120

    CAMACQ_SENSORDATA_X1_25_Zoom_0,
    CAMACQ_SENSORDATA_X1_25_Zoom_1,
    CAMACQ_SENSORDATA_X1_25_Zoom_2,
    CAMACQ_SENSORDATA_X1_25_Zoom_3,
    CAMACQ_SENSORDATA_X1_25_Zoom_4,
    CAMACQ_SENSORDATA_X1_25_Zoom_5,
    CAMACQ_SENSORDATA_X1_25_Zoom_6,
    CAMACQ_SENSORDATA_X1_25_Zoom_7,
    CAMACQ_SENSORDATA_X1_25_Zoom_8,

    CAMACQ_SENSORDATA_X4_Zoom_0, // 130
    CAMACQ_SENSORDATA_X4_Zoom_1,
    CAMACQ_SENSORDATA_X4_Zoom_2,
    CAMACQ_SENSORDATA_X4_Zoom_3,
    CAMACQ_SENSORDATA_X4_Zoom_4,
    CAMACQ_SENSORDATA_X4_Zoom_5,
    CAMACQ_SENSORDATA_X4_Zoom_6,
    CAMACQ_SENSORDATA_X4_Zoom_7,
    CAMACQ_SENSORDATA_X4_Zoom_8,

    CAMACQ_SENSORDATA_AUTO_CONTRAST_ON,
    CAMACQ_SENSORDATA_AUTO_CONTRAST_OFF, // 140
    CAMACQ_SENSORDATA_AE_LOCK,
    CAMACQ_SENSORDATA_AE_UNLOCK,
    CAMACQ_SENSORDATA_AWB_LOCK,
    CAMACQ_SENSORDATA_AWB_UNLOCK,
    
    CAMACQ_SENSORDATA_SET_AF,
    CAMACQ_SENSORDATA_SINGLE_AF_START,
    CAMACQ_SENSORDATA_OFF_AF,
    CAMACQ_SENSORDATA_CHECK_AF,
    CAMACQ_SENSORDATA_RESET_AF,    
    CAMACQ_SENSORDATA_MANUAL_AF, // 150
    CAMACQ_SENSORDATA_MACRO_AF,
    CAMACQ_SENSORDATA_RETURN_MANUAL_AF,
    CAMACQ_SENSORDATA_RETURN_MACRO_AF,
    CAMACQ_SENSORDATA_SET_AF_NLUX,
    CAMACQ_SENSORDATA_SET_AF_LLUX,    

    CAMACQ_SENSORDATA_SET_AF_NORMAL_MODE_1,        
    CAMACQ_SENSORDATA_SET_AF_NORMAL_MODE_2,
    CAMACQ_SENSORDATA_SET_AF_NORMAL_MODE_3,    
    CAMACQ_SENSORDATA_SET_AF_MACRO_MODE_1,    
    CAMACQ_SENSORDATA_SET_AF_MACRO_MODE_2, //160
    CAMACQ_SENSORDATA_SET_AF_MACRO_MODE_3,    

    CAMACQ_SENSORDATA_FLASH_INIT,
    CAMACQ_SENSORDATA_PRE_FLASH_ON,
    CAMACQ_SENSORDATA_PRE_FLASH_OFF,
    CAMACQ_SENSORDATA_FLASH_ON,
    CAMACQ_SENSORDATA_FLASH_OFF,
    CAMACQ_SENSORDATA_LOW_CAP_ON,
    CAMACQ_SENSORDATA_LOW_CAP_OFF,
    CAMACQ_SENSORDATA_PREVIEW_RETURN, // 169
#endif    // CONFIG_BCM_CAM_S5K4ECGX
...
#ifdef CONFIG_BCM_CAM_S5K4ECGX
GLOBAL U32 Drv_Saturation;
GLOBAL U32 Drv_Sharpness;
GLOBAL U32 Drv_Contrast;
GLOBAL U32 Drv_AutoContrast;
GLOBAL U32 Drv_FocusMode;
GLOBAL U32 Drv_AFCanceled;
GLOBAL U32 Drv_AECanceled;
GLOBAL U32 PreviewRet;
GLOBAL U32 Drv_LowCapOn;
#endif
GLOBAL S32 Drv_Mode;
