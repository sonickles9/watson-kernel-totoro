...
//
// Below are re-defines for the SmsApi_StartCellBroadcastWithChnlReq() interface
//
typedef struct 
{
    UInt16  start_pos;
    UInt16  stop_pos;
} MS_MN_CB_MSG_ID_RANGE;


typedef struct {
    MS_MN_CB_MSG_ID_RANGE  A[10];
}  MS_MN_CB_MSG_ID_RANGE_LIST;
...
//
// End SmsApi_StartCellBroadcastWithChnlReq()
