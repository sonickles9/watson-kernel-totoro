...
#else
void CAMDRV_GetISOSpeed(
        CamSensorSelect_t sensor
        );

void CAMDRV_GetShutterSpeed(
        CamSensorSelect_t sensor
        );
...
#else
HAL_CAM_Result_en_t  CAMDRV_SetBrightness(
        CamBrightnessLevel_t brightness,                      ///< (in) 
