...
#define BRCM_LOGIC_MODULE0_BASE		BCM21553_HANTRO_DEC_BASE
#else
#error bad chip
#endif
...
static struct cpufreq_client_desc *hantro_dec_client;
#endif
...
#ifdef CONFIG_CPU_FREQ_GOV_BCM21553
	hantro_dec_client = cpufreq_bcm_client_get("hantro_dec");
	if (!hantro_dec_client) {
